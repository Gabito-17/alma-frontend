...
const EstadoCivil = () => {
  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <table className="bg-white p-8 rounded-lg shadow-md w-full h-full mt-8 table-auto">
        <thead>
          <tr>
            <th className="px-4 py-2 border w-1/3 text-left">Nombre</th>
            <th className="px-4 py-2 border w-1/3 text-left">Descripcion</th>
            <th className="px-4 py-2 border w-1/3 text-left">Acciones</th>
          </tr>
        </thead>
        <tbody>
          {estadoscivil
            ...
            .map((estadoCivil) => (
              <tr key={estadoCivil.idEstadoCivil} className="hover:bg-gray-100">
                <td className="px-4 py-2 border">{estadoCivil.nombre}</td>
                <td className="px-4 py-2 border">{estadoCivil.descripcion}</td>
